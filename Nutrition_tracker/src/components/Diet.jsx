...
export default function Diet()
{
    ...
    return (
        <section className="container diet-container">
                ...
                <div className="previous-food">
                    <h2 className="heading">Track Your Diet : </h2>
                    <input type="date" className="input-field" onChange={(event)=>{
        ...
        <div className="finalitem">
            ...
            <h2>  Total Intake-{total.totalCaloreis.toFixed(2)} Kcal </h2>

            <p>Protein {total.totalProtein.toFixed(2)}g, Carbs {total.totalCarbs.toFixed(2)}g, Fats {total.totalFats.toFixed(2)}g, Fiber {total.totalFiber.toFixed(2)}g</p>
